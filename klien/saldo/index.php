		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-md-8">				
					<h3>Saldo</h3>
					<form id="saldo" method="POST" action="">
					  <div class="form-group">
					    <label for="user_id">User ID</label>
					    <input type="text" class="form-control" name="user_id_saldo" placeholder="User ID">
					  </div>
			...
			<div class="row">
				<div class="container panel panel-default">
					...
					<h4>
						...
						<?php
							if (isset($_POST['user_id_saldo'])) {
							
								$url = "https://izzunaqi.sisdis.ui.ac.id/ewallet/getSaldo/" . $_POST['user_id_saldo'];
								$ch = curl_init($url);
								...
								if ($saldo >= 0) {
									echo "Saldo " .$_POST['user_id_saldo']." adalah " .$saldo;	
								} else  {
